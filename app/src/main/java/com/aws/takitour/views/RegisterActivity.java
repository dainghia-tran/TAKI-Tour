...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(v -> {
            ...
            register(userEmail, userPassword, userRePassword, userFullName);
        });
    }

    private void register(String userEmail, String userPassword, String userRePassword, String userFullName){
